 ...
 * Aggregate frequency, as it does in V1.
 */
const InputText = (props) => {
    ...
    const handleKeyUp = event => {
        ...
        // PW 1.0 reads the native input at the moment Enter is handled.
        // Doing the same avoids committing a stale React state value when
        // typing and Enter happen in the same render frame.
        commitValue(
