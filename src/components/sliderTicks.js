...
/**
 * Build the ticks used by PW 1.0's `options.showTicks` contract.
...
/**
 * PW 1.0 labels the current handle(s) and the domain endpoints. Hide an
 * endpoint when a handle is extremely close to it so the labels do not
 * overlap (the old ngx-slider used the same visible behaviour).
 */
